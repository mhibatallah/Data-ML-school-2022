...
def run_pRNNWF_1DTFIM(numsteps = 10**4, systemsize = 20, num_units = 50, Bx = 1, num_layers = 1, numsamples = 500, activation = tf.nn.relu, learningrate = 5e-3, seed = 111):
    ...
    wf=RNNwavefunction(N,units=units,cell=tf.compat.v1.nn.rnn_cell.BasicRNNCell, activation = activation, seed = seed) #contains the graph with the RNNs
